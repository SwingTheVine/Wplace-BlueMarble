...
console.info(`${consoleStyle.BLUE}Starting update-version...${consoleStyle.RESET}`);
...
console.debug(`${consoleStyle.GREEN}Updated${consoleStyle.RESET} userscript version to ${consoleStyle.MAGENTA}${version}${consoleStyle.RESET}`);
